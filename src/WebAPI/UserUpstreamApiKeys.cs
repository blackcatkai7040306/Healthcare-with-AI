...
public static class UserUpstreamApiKeys
{
    ...
    static UserUpstreamApiKeys()
    {
        ...
        Register(new("backend_api", "backend", "backend api", "https://platform.stability.ai/account/keys", new("To use the Stability AI API in SwarmUI (via the comfy nodes or simple tab), you must set your key.")));
    }
}
